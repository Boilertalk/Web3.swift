        ...
        describe("ethereum quantity tests") {
            context("initialization") {
                ...
                it("should not initialize") {
                    expect{ try EthereumQuantity(ethereumValue: true) }.to(throwError())
                    expect{ try EthereumQuantity(ethereumValue: [1, 2, true, false]) }.to(throwError())
                    expect{ try EthereumQuantity(ethereumValue: "0x0x0x0x") }.to(throwError())
                }
            }
